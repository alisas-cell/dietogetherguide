...
export const coopFixPages = [
  {
    ...
    directAnswer: [
      ...
      'Quick Join, reconnect, and host-migration improvements are documented in official patch history. The developer FAQ confirms in-game voice chat and recommends using the same region when joining friends.',
    ],
    buildContext: 'Early Access live · Official co-op FAQ',
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'The feature is part of the official history. Exact current buttons, filters, fallback behavior, and waiting flow are not asserted because the present UI has not been directly captured.',
        ],
      },
      {
        id: 'crew-setup',
      ...
      },
      {
        ...
        paragraphs: [
          'The official developer FAQ says the game uses in-game voice chat and tells players to keep a microphone enabled. It does not document range behavior, push-to-talk controls, volume settings, or current defaults.',
          'Check the current in-game audio and input settings before treating a microphone symptom as a network failure. External crew communication remains a practical fallback.',
        ],
        callout: {
          type: 'build-check',
          title: 'Voice is confirmed; controls remain build-sensitive',
          body: 'Official FAQ evidence supports in-game voice chat, but not undocumented range, keybind, or default-setting claims.',
        },
      },
      {
        id: 'controls',
      ...
      },
      {
        ...
        paragraphs: [
          'If no public lobby appears, confirm client version, region, and Steam connectivity before changing system settings. If a run disconnects, use the in-game reconnect flow before restarting the entire crew.',
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes. The official developer FAQ confirms in-game voice chat and recommends keeping a microphone enabled; exact controls remain build-sensitive.',
      },
    ],
    sourceIds: ['S01', 'S07', 'S08', 'S10'],
    related: [
  ...
  },
  {
    ...
    description:
      'What the official Quick Join patch added, current region guidance, and safe checks when no public Last Pirates lobby appears.',
    ...
    directAnswer: [
      ...
      'The feature history and same-region developer guidance are confirmed, but this guide does not invent the current menu path or promise that a lobby is always available in every region.',
    ],
    buildContext: 'Early Access live · UI path unverified',
    confidence: 'confirmed',
    breadcrumbs: [
      { label: 'Home', href: '/' },
    ...
    sections: [
      ...
      {
        id: 'pre-ea-flow',
        heading: 'Public lobbies in the current evidence context',
        paragraphs: [
          'The July patch confirms public-lobby entry, while the current developer FAQ advises friends to use the same region. Neither source provides enough evidence for a click-by-click current menu tutorial.',
          'The guide therefore records the stable purpose and safe checks without inventing filters, status messages, cancel behavior, or no-session UI.',
        ],
      },
      {
        id: 'region',
      ...
      },
      {
        ...
        paragraphs: [
          'Confirm Steam is online and the game is updated. Then check the current region, cancel and retry once, restart the Steam client, and use Steam’s file verification if the client behaves abnormally.',
  ...
  },
  {
    ...
    directAnswer: [
      ...
      'Those are historical build facts. Steam now lists Steam Cloud for the live game, but Demo-to-Early-Access transfer and exact per-run persistence rules are not confirmed.',
    ],
    buildContext: 'EA live · Steam Cloud + patch history',
    confidence: 'confirmed',
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'The wording does not establish every variable that persisted, the current save location, or compatibility with Early Access. The current store separately lists Steam Cloud; that does not turn a Demo save into a transfer promise.',
        ],
      },
      {
        id: 'reconnect-screen',
      ...
      {
        id: 'known-fixes',
        heading: 'Known reconnect improvements in patch history',
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          'Transfer is not confirmed in the sources checked on Aug 19. The Demo and full game are separate Steam applications, and a Demo save feature does not automatically imply compatibility.',
    ...
    faqs: [
      {
        ...
        answer:
          'A June Demo patch documented chapter progress saving, and the current Steam page lists Steam Cloud. Exact run persistence and Demo transfer remain separate unanswered questions.',
      },
      {
        question: 'Can I reconnect after disconnecting?',
        answer:
          'Official patches added a reconnect screen and later reconnect/session fixes. Exact current prompts and recovery guarantees still need direct build evidence.',
      },
      {
  ...
  },
  {
    ...
    directAnswer: [
      'Before changing anything, confirm your PC meets the current Steam minimums and that the client is fully updated. Then restart Steam and use Steam’s file verification for abnormal client behavior.',
    ...
    sections: [
      {
        id: 'release-state',
        heading: 'Confirm the current client state first',
        paragraphs: [
          'Early Access is live on Steam. If an install or play control is missing now, refresh the store library state, finish client updates, and restart Steam before diagnosing a deeper launch failure.',
          'Confirm that the full game rather than the separate Demo application is selected. Record the visible client state and error so availability, update, and launch symptoms are not mixed together.',
        ],
      },
      {
        id: 'requirements',
        ...
        paragraphs: [
          ...
          'Store requirements can change during Early Access. Compare the current page before treating old copied specifications as authoritative.',
        ],
      },
      {
        id: 'steam-basics',
      ...
      },
      {
        ...
        paragraphs: [
          'The July official patch says FOV and invert-Y options improved. Their exact current labels and ranges still require direct verification.',
      ...
      },
      {
        ...
        paragraphs: [
          'Historical notes addressed Quick Join, reconnect, host migration, synchronization, save progress, display settings, Steam Deck support, and item or monster issues. That history identifies sensitive systems but is not a live outage board.',
          'One Aug 18 community thread reports occasional stuck monsters, attack pressure, and unspecified map bugs. This is a single community report, not proof of a global issue or a measured failure rate.',
        ],
      },
      {
        id: 'report',
        ...
        paragraphs: [
          'Stop after the standard update, restart, requirements, and file-verification checks if the same problem persists. Repeated invasive experiments make reports harder to interpret and can create new problems.',
    ...
    faqs: [
      {
        question: 'Why can’t I install or launch the game?',
        answer:
          'Early Access is live. Confirm the full game is selected, finish Steam updates, restart the client, and verify installed files if the client remains abnormal.',
      },
      {
  ...
  },
  {
    ...
    directAnswer: [
      ...
      'A historical patch mentioned Steam Deck support fixes, but this does not equal Valve Verified status. Check the current Steam compatibility badge rather than inferring one.',
    ],
    buildContext: 'Steam minimums · Checked Aug 19',
    confidence: 'confirmed',
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'These requirements were rechecked against the live Early Access store page on Aug 19. They can still change, so this page keeps the source date rather than assuming a frozen listing.',
        ],
      },
      {
        id: 'table',
      ...
      {
        id: 'performance',
        heading: 'Current performance checks',
        paragraphs: [
          'Verify native resolution, presets, FOV, frame limits, display mode, controller prompts, and the behavior of busy physics scenes. Recommendations need visible settings and repeatable observations.',
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'The current Steam page lists 5 GB available space.',
      },
      {
